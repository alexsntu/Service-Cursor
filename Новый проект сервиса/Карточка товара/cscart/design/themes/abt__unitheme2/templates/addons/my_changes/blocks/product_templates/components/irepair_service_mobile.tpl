{* iRepair: копия abt__ut2_mobile_template.tpl (UniTheme2), изменения помечены «iRepair». *}
...
{* iRepair: прокрутка к заголовку услуги после выбора опции (только мобильная версия) *}
